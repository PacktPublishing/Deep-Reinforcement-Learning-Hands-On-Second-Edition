...
if __name__ == "__main__":
    ...
    RunningAverage(output_transform=lambda v: v.get('reward', 0)).attach(engine, "avg_reward")
    handler = tb_logger.OutputHandler(tag="train", metric_names=['avg_loss', 'avg_reward'],
